...
const cards = [
  ...
  {
    title: 'Camping',
    image: 'https://images.unsplash.com/photo-1470940511639-1068d7764233?q=80&w=1600&auto=format&fit=crop',
  },
  {
    title: 'Sports',
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {cards.map((c) => (
            ...
            >
              <ImageWithFallback src={c.image} alt={c.title} className="absolute inset-0 w-full h-full object-cover" fallbackText={c.title} />
